...
use crate::routes::{
    address, asset_balance, asset_metadata, backup, btc_balance, cancel_invoice, change_password,
    ...
    get_asset_media, get_channel_id, get_payment, get_swap, hodl_invoice, init, invoice_status,
    ...
    post_asset_media, refresh_transfers, restore, revoke_token, rgb_invoice, send_asset, send_btc,
    send_onion_message, send_payment, settle_invoice, shutdown, sign_message, sync, taker, unlock,
};
